...
pub enum SageInstruction {
    ...
    CloseFleetCargoPodTokenAccount(close_fleet_cargo_pod_token_account::CloseFleetCargoPodTokenAccount),
    ClosePlayerCrewRecord(close_player_crew_record::ClosePlayerCrewRecord),
    CloseStarbaseCargoTokenAccount(close_starbase_cargo_token_account::CloseStarbaseCargoTokenAccount),
    ...
    CreateStarbaseUpgradeResourceProcess(create_starbase_upgrade_resource_process::CreateStarbaseUpgradeResourceProcess),
    ...
    DeregisterSurveyDataUnitTracker(deregister_survey_data_unit_tracker::DeregisterSurveyDataUnitTracker),
    ...
    SyncStarbaseUpgradeIngredients(sync_starbase_upgrade_ingredients::SyncStarbaseUpgradeIngredients),
